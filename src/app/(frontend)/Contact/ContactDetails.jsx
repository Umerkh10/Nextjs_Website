...
<div className='absolute top-14 w-full h-[90vh] -z-10' 
  ...
  <div className='relative z-10'data-aos='fade-up' > 
    ...
    className=' md:max-w-[460px] m-auto xl:ml-[700px] pt-12 pb-12 pr-10 pl-10 h-[90vh] '>
      <span className='text-gray-200 text-3xl md:text-5xl font-extrabold flex justify-center'>Contact Info</span>
      <div className='flex  gap-0 mt-10'>
        ...
        <div className='flex flex-col'>
          <div className='pl-4 text-gray-200 font-bold text-lg md:text-xl'>Office Address</div>
          <div className='text-gray-200 opacity-70 text-sm md:text-base pl-4'>60a Oldham St, Manchester M4 1LE, United Kingdom</div>
          </div>
      </div>
      ...
      <div className='flex  gap-0 mt-10'>
        ...
        <div className='flex flex-col'>
          <div className='pl-3 text-gray-200 font-bold text-lg md:text-xl'>Phone Number</div>
          <div className='text-gray-200 opacity-70 text-sm md:text-base pl-3'>021-34155132</div>
          <div className='text-gray-200 opacity-70 text-sm md:text-base pl-3'>021-34155132</div>
          </div>
      </div>
      ...
      <div className='flex  gap-0 mt-10'>
        ...
        <div className='flex flex-col'>
          <div className='pl-3 text-gray-200 font-bold text-lg md:text-xl'>Mail Address</div>
          <div className='text-gray-200 opacity-70 text-sm md:text-base pl-3'>support@webnike.com </div>
          </div>
      </div>
    </div>
  </div>
