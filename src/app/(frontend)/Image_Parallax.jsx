            ...
            <div className='grid col-span-4' data-aos="fade-right">
                <div className='relative ml-5'>
                    <div className='mb-7'>
                        ...
                        <h2 className='font-extrabold text-5xl mb-6'>Committed to Delivering <br /> Outstanding Service</h2>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-5 mb-7'>
                            <div className='flex items-center gap-2'>
                                ...
                                <h4 className='font-semibold capitalize text-lg'>Save More with Our Solutions</h4>
                            </div>
                        ...
                        <div className='h-[1px] bg-gray-600 mt-8'>
                            <div className='flex items-center w-[75%] xl:w-[20%] lg:w-[26%] md:w-[40%] group'>
                                <Link href="/Services" className='mt-8 text-sky-600 bg-transparent text-[18px] font-semibold leading-none capitalize border border-sky-500 rounded-full px-8 py-5 group-hover:translate-x-10 transition duration-300 hover:bg-sky-600 ease-in delay-100 hover:text-white group'>
