  ...
  return (
    ...
    <div className='' data-aos="flip-right">
        <div className='bg-slate-200 rounded-2xl p-4 sm:p-10 mt-10'>
            ...
            <div className='pt-3 font-normal text-lg text-purple-700 '>Get More Web Development Updates</div>
            <form action={action} ref={formRef}>
                <div class="flex flex-col justify-end pt-10">
                    ...
                    <input placeholder="Enter Your Email Address Here.." name='email' type="email" class="h-16 rounded-xl mt-6 p-6 outline-none "/>
