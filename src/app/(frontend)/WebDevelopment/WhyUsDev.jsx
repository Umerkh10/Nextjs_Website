...
const WhyUsDev = () => {
  ...
  return (
    <div className='bg-gray-200 dark:bg-transparent p-4'>
        ...
        <div className='grid lg:grid-cols-5 md:grid-cols-3 grid-cols-1 p-5'>

            <div className='group p-4 border-black rounded-full bg-transparent hover:bg-sky-200' data-aos="flip-right" >
            ...
            <div className=' group p-4 border-black rounded-full bg-transparent hover:bg-sky-200' data-aos="flip-left">
                <div className='flex items-center justify-center'>
                <div className='border rounded-full w-28 h-28 bg-sky-200 group-hover:bg-purple-500 transition ease-in duration-200 delay-100 '>
                    <div className='flex justify-center'>
