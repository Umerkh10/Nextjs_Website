...
const Testimonials = () => {
  ...
  return (
    <div className='pb-10 pt-28 relative z-[1]' >
        <div class="absolute mt-10 top-0 left-0 h-screen md:h-[125vh] lg:w-[58%] lg:h-[78vh] rounded rounded-r-[500px] overflow-hidden -z-10" data-aos="fade-right">
