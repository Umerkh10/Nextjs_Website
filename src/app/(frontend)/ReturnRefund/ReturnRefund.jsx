    ...
    return (
        <>
            ...
            <div className='ml-8 mr-8 mt-10 mb-10' data-aos='fade-right' >
                <div className='text-4xl text-slate-800 font-extrabold'>Return Refund Policy</div>
                <div className='mt-3 text-base text-slate-900 opacity-80 font-medium '>Refund provides you Masterminds Enterprises designs. Our design package allows the users to get the 100% refund granted by Masterminds Enterprises while our 100% policy is not available on banner design, stationary design, brochure design, and website design. According to our refund policy:</div>

                <ul className='flex flex-col mt-5 gap-1 '>
                    <li className='flex font-medium text-base text-slate-800 mb-2 gap-3'>
