       ...
       autoplay={{ delay: 5000, disableOnInteraction: true }}  loop={true} ref={swiperRef} className='w-full h-full'>
        ...
        <div id='slider' className='grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1'>
          <div className='col-span-1 order-2 lg:order-1 w-full mx-auto relative'>
            ...
            <Image loading='eager' className='xl:ml-16 -translate-x-[4.25rem] md:-translate-x-0 lg:-translate-x-0 xl:-translate-x-0 translate-y-16 xl:-translate-y-12 lg:translate-y-4 md:-translate-y-48 text-to-reveal' src='/imgs/home-banner-2.webp' width={600} height={600} alt='banner' />
          </div>
        ...
        <div  className='grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1'>
          <div className='col-span-1 order-2 lg:order-1 w-full mx-auto relative'>
            <Image loading='eager' className='xl:ml-8 -translate-x-[1.75rem] md:-translate-x-0 lg:-translate-x-0 xl:translate-x-10 translate-y-40 xl:translate-y-4 lg:translate-y-4 md:-translate-y-48 text-to-reveal'
        ...
        <div className='grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1'>
          <div className='col-span-1 order-2 lg:order-1 w-full mx-auto relative'>
            ...
            <Image loading='eager' className='lg:flex mt-20 pl-7 xl:ml-16 -translate-x-[2.25rem] md:translate-x-10 lg:-translate-x-0 xl:-translate-x-9 translate-y-24 xl:-translate-y-20 lg:-translate-y-28 md:-translate-y-48 text-to-reveal'
