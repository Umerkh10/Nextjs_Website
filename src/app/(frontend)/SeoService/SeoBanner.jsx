  ...
  return (
    <div className='grid lg:grid-cols-2 grid-cols-1' data-aos="fade-up" >
        <div className='bg-purple-700  p-5'>
            ...
            <button onClick={handleClick} className='mt-5 border rounded-2xl w-[60vw] md:w-[30vw] lg:w-[22vw] h-[10vh] flex items-center justify-center relative overflow-hidden bg-sky-600 font-medium text-white group hover:bg-sky-900 transition ease-in duration-200 delay-200 '> 
