    ...
    <div className='bg-slate-200 dark:bg-transparent pr-6 pl-6 pt-16'>
        ...
        <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 p-6' ref={ref}>
            ...
            <div className='group' data-aos="flip-right">
                <div className=' border-black border-[4px] rounded-xl h-[45vh] bg-purple-500 pl-4 pr-4 group-hover:border-sky-300 group-hover:border-[4px] group-hover:scale-105 group-hover:shadow-2xl transition ease-in duration-200 delay-150 '>
