...
const AppBannner = () => {
  return (
    <div>
        <div style={{backgroundImage:"url('/imgs/App_banner.webp')",backgroundSize:'cover',backgroundPosition:'center' }} className='h-[170vh] lg:h-[100vh]'>

        <div className='grid lg:grid-cols-2 grid-cols-1 pt-28'>
            <div className=' pl-10 pr-10 lg:pt-16 pt-5 '>
            ...
            <div className='mt-5 border rounded-2xl w-[60vw] md:w-[35vw] lg:w-[22vw] h-[10vh] flex items-center justify-center relative overflow-hidden bg-orange-500 font-medium text-white group hover:bg-sky-700 transition ease-in duration-200 delay-200 '> 
