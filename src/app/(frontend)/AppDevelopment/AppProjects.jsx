...
const AppProjects = () => {
  return (
    <div className='bg-slate-200 dark:bg-transparent pr-6 pl-6 pt-10'>
        <div className='text-5xl font-extrabold text-center' data-aos="fade-up" >Our App Development Projects</div>
        ...
        <Swiper
                 modules={[ Autoplay,Navigation]} spaceBetween={30} slidesPerView={1} autoplay={{ delay: 5000, disableOnInteraction: false }}  loop={true} className='mt-10'>
                    ...
                    <SwiperSlide>
                   <div data-aos="zoom-out" className='flex justify-center items-center group p-10'>
                    ...
                    <SwiperSlide>
                    <div data-aos="zoom-in" className='flex justify-center items-center group p-10'>
