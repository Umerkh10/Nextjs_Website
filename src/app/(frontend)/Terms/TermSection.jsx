...
const TermSection = () => {
  ...
  return (
    ...
    <div className='mt-3 text-base  font-medium '>These terms explain how you can use our service. Agreeing to them lets you continue, and disagreeing means you shouldn't use it. We can change these terms later, but you'll always know.</div>
    <div className='mt-3 text-base  font-medium '>Show drafts volume_up This document outlines the terms and conditions that govern your access and use of our service. By using our service, you acknowledge that you have read, understood, and agree to be bound by these terms. If you disagree with any of these terms, you are prohibited from using the service. We reserve the right to update these terms at any time without prior notice. </div>
    
    <div className=' mt-5 text-3xl  font-bold'>Product Delivery</div>
    <div className='mt-3 text-base  font-medium '>Excellent news! Your order for the [product name] is on its way. Our fulfillment center is meticulously packaging it to ensure it arrives in pristine condition. Once it ships, you'll receive an email notification containing a tracking code. This unique code grants you access to a real-time map where you can follow your package's progress, from leaving the warehouse to reaching your doorstep. We understand the thrill of anticipation, so feel free to use the tracker to monitor its exciting journey (but please, avoid stalking the delivery person!).</div>

    <div className=' mt-5 text-3xl  font-bold'>Product Compatibility / Updates</div>
    <div className='mt-3 text-base  font-medium '>Ensuring product compatibility is key to a well-functioning system.  Before adding a new device or software, check the manufacturer's website for compatibility information.  They often have resources like compatibility charts or tools to verify if your existing products will work with the new addition. </div>
    <div className='mt-3 text-base  font-medium '>We collect Device Information using the following technologies:</div>
