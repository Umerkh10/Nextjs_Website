  ...
  return (
    <div className='lg:grid lg:grid-cols-3 flex flex-col pl-4 pr-4 '>
        ...
        <div className='col-span-2  p-8' data-aos="fade-down" >
            ...
            <div className='text-xl font-semibold'>Recipient of the 2019 National Excellence Award
            <br /> 
            </div>
            <div className='text-blue-500 text-lg font-medium'>2019 - 2021</div>
            </div>
            ...
            <div className='text-xl font-semibold'>Recipient of the 2019 Galaxy Award for Excellence 
            <br /> 
            </div>
            <div className='text-blue-500 text-lg font-medium'>2019 - 2021</div>
            </div>
            ...
            <div className='text-xl font-semibold'>Celebrating excellence in global brand recognition.
            <br /> 
            </div>
            <div className='text-blue-500 text-lg font-medium'>2019 - 2021</div>
            </div>
