...
const ServiceBanner = () => {
  ...
  return (
    ...
    className=' top-0 left-0 h-full  z-[-1] bg-blend-overlay bg-zinc-800 pt-[280px] pb-[180px] '>
        <div className='text-gray-200 flex items-center justify-start ml-10 text-6xl font-extrabold mb-8'>Service</div>
        ...
        <div className='text-purple-600 text-opacity-75 text-[22px] font-semibold '>Services </div>
