...
const ServiceBanner = () => {
  ...
  return (
    ...
    className=' top-0 left-0 h-full  z-[-1] bg-blend-overlay bg-zinc-800 pt-[280px] pb-[180px] '>
        ...
        <div className='border border-dashed border-purple-800 rounded-full w-[40%] md:w-1/3 lg:w-1/4 xl:w-1/5 flex items-center justify-start ml-10 pt-4 pb-4 pl-4 pr-4 mt-3'> 
