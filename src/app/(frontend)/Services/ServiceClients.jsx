...
const ServiceClients = () => {
    ...
    return (
        <div className='mt-10 lg:grid lg:grid-cols-2 grid-cols-1 h-full w-full '>
            <div data-aos="fade-down" className='bg-blue-500 h-[80vh] p-5 -z-10 group'>
            ...
            <div data-aos="fade-up" className='bg-gray-50 dark:bg-slate-950  h-[85vh] z-30 p-5 '>
                <div className=' text-xl font-semibold text-blue-600 dark:text-white'> Our Clients </div>
                <div className=' mt-5 text-5xl font-extrabold dark:text-white'> We Build With <br />Modern Experience Brands </div>

                <a href="#" className='flex justify-center items-center mt-5 no-underline text-lg rounded-xl w-[35%] h-[12%] border-[1px] font-medium text-blue-500 border-blue-500 relative overflow-hidden transition duration-500 group hover:bg-blue-700 hover:text-white  '>
