            ...
            data-aos="zoom-in">
                ...
                <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-5 gap-3 mb-10 '>
                    <div className='group p-4 ' data-aos="flip-right">
                        <div className='p-2 border-violet-800 border-[5px]  group-hover:border-zinc-900 group-hover:scale-110 group-hover:bg-violet-800 transition ease-in duration-200 delay-150 rounded-lg h-[55vh]'>
                    ...
                    <div className='group p-4 ' data-aos="flip-left">
                        <div className='p-2 border-[5px] border-violet-800 group-hover:border-zinc-900 group-hover:scale-110 group-hover:bg-violet-800  transition ease-in duration-200 delay-150 rounded-lg h-[55vh]'>
