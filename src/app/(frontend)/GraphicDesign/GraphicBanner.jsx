...
const handleClick = () => {
  if (typeof window !== 'undefined' && typeof window.openChat !== 'undefined') {
    ...
    return (
        ...
        <div className='lg:pt-52 md:pt-14 pt-36 text-gray-400 text-center text-2xl md:text-3xl font-bold italic' data-aos="flip-up">Transform Your Vision Into Reality</div>
