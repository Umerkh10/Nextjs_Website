        ...
        <div ref={ref}>
            <div className='mx-auto mt-14 w-full text-foreground/80' data-aos="fade-right">
                ...
                <div className='flex flex-col lg:flex-row lg:justify-between pl-10 pr-10'>
                    ...
                    <div className='flex sm:justify-end items-center w-[95%] xl:w-[20%] lg:w-[27%] md:w-[40%] group'>
                        ...
                        <div className='flex items-center justify-center w-[50px] h-[50px] rounded-full bg-sky-600 mt-8 ml-2 sm:group-hover:-translate-x-48 group-hover:-translate-x-44 transition duration-200 delay-150 ease-in-out'>
